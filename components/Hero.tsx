...
import { PencilIcon, CameraIcon, PhotoIcon, SunIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        {/* Top Left: Sketch -> Photo */}
        <div className="hidden lg:block">
            <DrawingTransformation 
            initialIcon={PencilIcon} 
            finalIcon={CameraIcon} 
            label="PHOTO"
            delay={0} 
            x="4%" 
            y="8%"
        ...
        {/* Top Right: Storyboard -> Scene */}
        <div className="hidden lg:block">
            <DrawingTransformation 
            initialIcon={FilmIcon} 
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-white mb-6 leading-[1.1]">
          Studio Photo <br/>
          <span className="underline decoration-4 decoration-purple-500 underline-offset-4 md:underline-offset-8 text-white">IA Pro</span>.
        </h1>
        <p className="text-base sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light">
          Transformez vos photos originales en shootings professionnels (Produit, Portrait, Intérieur, etc.) instantanément.
        </p>
      </div>
    </>
  );
